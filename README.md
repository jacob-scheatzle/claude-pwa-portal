...
- **Public intake forms.** An app can declare no-sign-in forms served at `/forms/<slug>/<form>`; customer submissions collect under **Admin → Submissions** (with CSV export). The inbound complement to share links — push a PDF out, take structured data in.
